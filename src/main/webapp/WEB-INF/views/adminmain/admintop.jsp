      ...
      <div class="text-align-center con">
         ...
         <c:choose>
            <c:when test="${loginState==true }">
              ...
              <span class="logout"><a href="logout">로그아웃</a></span></li>
            </c:when>
            <c:otherwise>
         ...
         <nav class="menu-bar__menu-box-1">
            <ul class="inline-grid">
               <li>
                  <a href="#">영화관리</a>
                    <ul>
                      <li><a href="moviein">영화입력</a></li>
                      <li><a href="movieout">관리자영화출력</a></li>
                    </ul>         
               </li>
               <li>
                  <a href="#">배우관리</a>
                    <ul>
                       <li><a href="actorin">배우 입력</a></li>
                       <li><a href="actorout">배우 출력</a></li>
                    </ul>
               </li>
                <li>
                  <a href="#">스케줄관리</a>
                    <ul>
                       <li><a href="schedulein">상영일정입력</a></li>
                      <li><a href="scheduleout">상영일정출력</a></li>
                    </ul>
               </li>
                <li>
                  <a href="#">예매관리</a>
                    <ul>
                       <li><a href="ticketout">회원예매출력</a></li>
                    </ul>
               </li>
               <li>
